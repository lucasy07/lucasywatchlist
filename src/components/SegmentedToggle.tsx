      ...
      {options.map((option) => {
        ...
        return (
          <Button
            ...
            aria-pressed={active}
            className={`focus-ring relative z-10 flex h-11 min-w-11 items-center justify-center rounded-md px-2.5 text-xs font-medium transition-colors duration-200 hover:bg-transparent sm:h-8 sm:min-w-8 ${
              active
